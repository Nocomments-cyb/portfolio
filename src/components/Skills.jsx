      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-2 text-xs font-mono text-cyan-400 uppercase tracking-widest mb-2">
            ...
            <span>03 // Technical Toolchain</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-white">
            Skills & Capabilities
          </h2>
          <p className="text-slate-400 mt-2 max-w-xl text-sm sm:text-base">
            Grounded in modern web standards and practical application. Organized by architectural domain without arbitrary rating percentages.
          </p>
        </div>
